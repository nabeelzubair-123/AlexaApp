...
mongoose.connect('mongodb+srv://dbnabeel-123:Cisco123098npm i ng@my-app.ueyt1.mongodb.net/myFirstDatabase?retryWrites=true&w=majority');
...
const LaunchRequestHandler = {
  ...
  handle(handlerInput) {
    ...
    const speakOutput = 'Welcome to jaddah restaurant, I am your virtual assistant. you can ask for the menu';
